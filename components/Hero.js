      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 max-w-3xl mx-auto mt-20 flex flex-col justify-center space-y-10">
          ...
          <div className="flex flex-col space-y-2 pt-5 px-10 sm:space-y-0 sm:h-[5rem] sm:flex-row sm:justify-center sm:place-items-center  sm:space-x-4">
            <button className="bg-fluent-50 text-fluent-220 py-2 sm:w-[10rem] text-center sm:ring-fluent-50 hover:bg-fluent-70 rounded-sm">Search Blogs</button>
            <button className="text-fluent-50 py-2 sm:w-[10rem] sm:ring-1   sm:ring-fluent-50 text-center bg-black/20 hover:bg-black/50 rounded-sm">About Me</button>
          </div>
        </div>
