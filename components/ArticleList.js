...
export default function ArticleList({ postsData, limit, filter, size, topic }) {
      ...
      <div className="mx-auto max-w-5xl my-10 md:my-16 px-2 sm:px-8">
        ...
        <Link href={`/topic/${filter}`} key={topic}>
          <div className={styles.title}>
            ...
            <span className="text-fluent-30 text-2xl font-semibold">{topic}</span>

            <div className="flex place-items-center">
              <span className={styles.showmore}> Explore </span>
              <svg
